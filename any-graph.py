...
flooding_path_cache, connection_count = flooding(G, start_node, resource, update, cache_bfs)
...
random_walk_path, connection_count = random_walk(G, start_node, resource, update, cache_dfs)
print("connection_count:", connection_count)
